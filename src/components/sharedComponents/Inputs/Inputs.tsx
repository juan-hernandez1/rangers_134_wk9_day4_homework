...
import { forwardRef } from 'react' // allow our component forms to forward the info/data coming from user
...
export const InputText = forwardRef((props: inputState, ref) => {
    return (
        <TextField
            variant='outlined'
            margin='normal'
            inputRef={ref} // data coming from user submit all will be forwarded to the form using this input box
            fullWidth
            type = 'text'
            {...props}
        >
